...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <script src=" {{asset('template\public\assets/js/config.js')}}"></script>


    <!-- ===============================================-->
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link rel="stylesheet" href=" {{asset('template\public\vendors/swiper/swiper-bundle.min.css')}}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet">
    <link href=" {{asset('template\public\assets/css/theme.css')}}" rel="stylesheet" id="style-default">
    <link href=" {{asset('template\public\assets/css/user-rtl.css')}}" rel="stylesheet" id="user-style-rtl">
    <link href=" {{asset('template\public\assets/css/user.css')}}" rel="stylesheet" id="user-style-default">
  ...
  <body>
      ...
      <main class="main" id="top">
        ...
        <div class="content">
          ...
          <footer class="Footer" style="background-image: url('{{asset('template/public/assets/img/illustrations/BOTTOM.png')}}') ">
            <div class="pb-x1 px-3 px-lg-0">
              <div class="container">
                <div class="row align-items-end g-4 g-sm-6">
                  <div class="col-6 col-md-4">
                    <div class="mb-6 mb-md-8"><a class="cursor-pointer" href=""><img class="img-fluid" src=" {{asset('template\public\assets/img/logos/Footer_logo.png')}}" alt="" /></a></div>
                    <div>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src=" {{asset('template\public\vendors/popper/popper.min.js')}}"></script>
    ...
    <script src=" {{asset('template\public\vendors/countup/countUp.umd.js')}}"></script>
    <script src=" {{asset('template\public\vendors/swiper/swiper-bundle.min.js')}}"></script>
    <script src=" {{asset('template\public\vendors/lodash/lodash.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src=" {{asset('template\public\vendors/list.js/list.min.js')}}"></script>
